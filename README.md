...
Добавлен логотип в меню: /ts/build/packages/messagebox/lib/pixmaps/nixts.org.xpm (В файле /ts/build/packages/base/etc/dialog.functions прописана опция выводить картинку "--icon /lib/pixmaps/nixts.org.xpm \").
